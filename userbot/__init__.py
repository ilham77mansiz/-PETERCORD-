...
CUSTOM_HELP = os.environ.get("CUSTOM_HELP", r".")
...
SUDO = sb(os.environ.get("SUDO", "False"))

SUDO_USERS = set(int(x) for x in os.environ.get("SUDO_USER", "").split())
...
HELP_LOGO = os.environ.get(
    "HELP_LOGO", "https://telegra.ph/file/dadd789a1b1b677d0f325.jpg")
...
PETERCORD_USERBOT = sb(os.environ.get("PETERCORD_USERBOT", "True"))
