...
from userbot import CMD_HELP, bot as Petercord
from . import petercordbot, petercordsudo, register


@Petercord.on(petercordbot(outgoing=True, pattern="covid(?: |$)(.*)"))
@Petercord.on(petercordsudo(pattern="covid(?: |$)(.*)", allow_sudo=True))
