...
from userbot import ALIVE_LOGO, SUDO_USERS, ALIVE_NAME, BOT_VER, CMD_HELP, StartTime, UPSTREAM_REPO_BRANCH, bot
from . import register, petercordbot, petercordsudo, Petercord


# ================= CONSTANT =================
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else uname().node
# ============================================
petersudo = SUDO_USERS
...
@Petercord.on(petercordbot(outgoing=True, pattern="spc$"))
@Petercord.on(petercordsudo(pattern="spc$", allow_sudo=True))
async def psu(event):
...
@Petercord.on(petercordbot(outgoing=True, pattern="alive$"))
@Petercord.on(petercordsudo(pattern="alive$", allow_sudo=True))
async def amireallyalive(alive):
    user = await bot.get_me()
    await get_readable_time((time.time() - StartTime))
    output = (
